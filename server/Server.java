	...
	private static class CLientHandler extends Thread {
		...
		public void run() {
			try {
				...
				int triesLeft = 4;
				ServerOperations.setFileLocation(JSONLOCATION);
				while (true) {
					...
					if (action.equals("LOGIN")) {
						...
						if (ServerOperations.logUserIn(usrName, pw, JSONLOCATION)) {
					...
					//the user prompts to register a new account
						...
						if (ServerOperations.registerUser(usrName, pw, JSONLOCATION)) {
							write("SUCCESS");
							userAllowed = true;
							break;
						} else {
